...
public class TabMyListActivity extends FragmentActivity implements ActionBar.TabListener {
  ...
  // slide menu items
	...
	private void themeChange(int customer_level){
		...
		if (sl >= customer_level){
  		...
  		final AlertDialog alert = new AlertDialog.Builder(TabMyListActivity.this).create();
  	...
  	private void displayView(int position) {
		...
		case 1:
			...
			new Handler().postDelayed(new Runnable() {
		        @Override
		        public void run() {
		        	Intent fro = new Intent(getApplicationContext(), TabLayoutActivity.class);
